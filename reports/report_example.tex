...
\centering
\small
\caption{Summary statistics --- replication of Martin \& Shi (2025), Table~1, over
January 1996--December 2022. The lower bound tracks the realized crash frequency,
while the risk-neutral probability and the upper bound overstate crash risk.}
\label{table:table1}
