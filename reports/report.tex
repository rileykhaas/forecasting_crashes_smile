...
\paragraph{Figure 1 --- bounds for individual stocks.} Figure~1 plots the time
series of the option-implied upper and lower bounds on the one-month probability of
a $20\%$ crash for two representative names, Apple and AIG. It shows how the bounds
move with market stress, and how far apart the ``cries wolf'' risk-neutral reading
and the fear-corrected lower bound can be for a single name.
\pending{Figure 1 --- one-month 20\% crash-probability bounds for Apple and AIG}
