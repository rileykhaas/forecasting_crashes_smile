...
\paragraph{Figure 2 --- the market and the cross-section.} Figure~2 plots the
cross-sectional medians of the upper and lower bounds over time, together with the
crash probability of the S\&P~500 index itself (the $i = m$ case of Result~3). It
lifts the single-name picture to the aggregate and shows that the market crash
probability is lower and smoother than the typical constituent's.
\pending{Figure 2 --- cross-sectional median bounds and the S\&P 500 index crash probability}
